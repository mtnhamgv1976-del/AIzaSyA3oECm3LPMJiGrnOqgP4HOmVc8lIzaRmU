...
<div class="main-header">
    ...
    <p>Tác giả: Ma Thị Nhậm - Trường PTDTBT Tiểu học Kiên Đài - ĐT: 036 8774 268</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Thị Nhậm - Trường PTDTBT Tiểu học Kiên Đài - ĐT: 036 8774 268</div>", unsafe_allow_html=True)
